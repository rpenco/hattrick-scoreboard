...
import org.hattrick.models.avatar.PlayerAvatar;
 ...
 * @since 7 aot 2014
 */
public class PlayersAvatarProcess extends HProcess {

    static final String TAG = (PlayersAvatarProcess.class).getSimpleName();
    ...
    public void perform(IRequest request, IParams params) {
        ...
        params.setResultClass(PlayersAvatar.class);
        ...
        // Foreach player
        for (PlayerAvatar player : res.getPlayers()) {
            ...
            String filename = "avatar_" + player.getPlayerID() + ".png";
