...
public class BookmarksUpdate extends Update {

    public static String FROM = "bookmark";
    ...
    public <T> void update(String TAG, Context context, IRequest request,
        ...
        setTag((BookmarksUpdate.class).getSimpleName());
        setFrom(FROM);

        super.update(TAG, context, request, params, datasource,
                BookmarksProcess.class, forceUpdate);
    }
}