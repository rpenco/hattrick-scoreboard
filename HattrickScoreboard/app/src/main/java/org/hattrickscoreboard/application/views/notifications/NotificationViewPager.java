 ...
 * @since 29 march 2014
 */
public class NotificationViewPager extends HattrickViewPagerFragment {

    static final String TAG = (NotificationViewPager.class).getSimpleName();

    public NotificationViewPager() {
        super();
    }
    ...
    public List<HattrickFragment> getFragments() {
        ...
        fList.add(new NotificationFragment().newInstance());
        titles.add(toUpperCase(R.string.menu_notifications));
