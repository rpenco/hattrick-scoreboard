...
public class HattrickNavigationActivity extends FragmentActivity implements
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        supportScreen.putInt("teamID",
                ((HattrickApplication) getApplication()).getSelectedTeamID());
    ...
    public void restoreActionBar() {
        ...
        HattrickApplication app = ((HattrickApplication) getApplication());
        if (app != null) {
            DTeam selectedTeam = app.getSelectedTeam();
    ...
    protected void selectItem(int tag, int position) {
        mNavigationDrawerFragment.selectItem(tag, position);
    }
}
