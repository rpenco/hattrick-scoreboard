 ...
 * @since 14 aout 2014
 */
public class TransfersPlayersAdapter extends BaseAdapter {

    @SuppressWarnings("unused")
    private static final String TAG = (TransfersPlayersAdapter.class).getSimpleName();

    private List<HPlayer> playerslist;
    private Context context;

    public TransfersPlayersAdapter(Context context, List<HPlayer> players,
                                   FragmentManager fm) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Prepare view holder
        TransfersPlayersHolder playersHolder;
        ...
        playersHolder = new TransfersPlayersHolder(context);
