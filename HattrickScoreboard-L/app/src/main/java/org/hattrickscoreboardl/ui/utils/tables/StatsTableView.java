...
public class StatsTableView {
    ...
    public StatsTableView(Context ctx) {
        this.ctx = ctx;
    ...
    public void createHeaders(String label, String value) {

        //Header
        TableRow tableRow = new TableRow(ctx);
//        tableRow.setBackgroundResource(R.color.drawerTitleSeparator);
    ...
    public void createRow(String label, String value){
