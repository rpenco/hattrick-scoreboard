 ...
 * on 14/12/2014.
 */
public class Display1View extends TextView {

    public Display1View(Context context) {
        super(context);
        setInitAttributs();
    }

    public Display1View(Context context, AttributeSet attrs) {
        super(context, attrs);
        setInitAttributs();
    }

    private void setInitAttributs() {
        setTextSize(Utils.dimen(getContext(), R.dimen.text_size_34));
