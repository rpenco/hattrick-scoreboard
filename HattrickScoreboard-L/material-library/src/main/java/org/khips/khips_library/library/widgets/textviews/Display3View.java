 ...
 * on 14/12/2014.
 */
public class Display3View extends TextView {

    public Display3View(Context context) {
        super(context);
        setInitAttributs();
    }

    public Display3View(Context context, AttributeSet attrs) {
        super(context, attrs);
        setInitAttributs();
    }

    private void setInitAttributs() {
        setTextSize(Utils.dimen(getContext(), R.dimen.text_size_56));
